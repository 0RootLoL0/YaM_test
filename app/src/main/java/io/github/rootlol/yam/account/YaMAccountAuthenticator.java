...
import io.github.rootlol.yam.activity.Login;

public class YaMAccountAuthenticator extends AbstractAccountAuthenticator {

    private final Context mContext;

    public YaMAccountAuthenticator(Context context) {
        super(context);
        mContext = context;
    }
            ...
            throws NetworkErrorException
    {
        ...
        intent.putExtra(Login.ARG_AUTH_TOKEN_TYPE, authTokenType);
